...
class City(models.Model):
    city_name = models.CharField(max_length = 200, primary_key = True)
...
class BloodGroupType(models.Model):
    ...
    bloodtype = models.CharField(max_length = 200, choise = blood_list)
...
class NotDonate(models.Model):
    ...
    notdonate = models.CharField(max_length = 300)

class Medication(models.Model):
    medication_id = models.AutoField(primary_key = True)
    medication = models.CharField(max_length = 300)
    waiting_time = models.CharField(max_length = 300)
...
class Details(models.Model):
    ...
    # bloodgroup = models.ForeignKey(BloodGroupType, on_delete=models.SET_NULL)
